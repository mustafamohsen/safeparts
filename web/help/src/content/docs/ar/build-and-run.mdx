...
- Rust stable (يُفضّل rustup) + <span class="token token--mono" dir="ltr">rustfmt</span> و <span class="token token--mono" dir="ltr">clippy</span>
...
واجهة الويب موجودة في <span class="token token--mono" dir="ltr">web/</span> وتتطلب خطوة بناء WASM.
...
هذا الموقع مبني بـ Starlight داخل <span class="token token--mono" dir="ltr">web/help/</span> ويُنشر تحت <span class="token token--mono" dir="ltr">/help/</span>.
...
- [http://localhost:4321/help/](http://localhost:4321/help/) (English)
- [http://localhost:4321/help/ar/](http://localhost:4321/help/ar/) (العربية)
