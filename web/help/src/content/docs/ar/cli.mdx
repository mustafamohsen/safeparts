...
افتراضياً يقرأ من stdin ويكتب إلى stdout ما لم تمرر <span class="token token--mono" dir="ltr">-o</span>.
...
:::caution
يفضّل استخدام <span class="token token--mono" dir="ltr">--passphrase-file</span> بدلاً من <span class="token token--mono" dir="ltr">--passphrase</span> في البيئات التي تحتفظ بسجل الأوامر.
:::
