...
- On Windows: run `python windows/scripts/package-release.py 0.3.1 <x64|arm64>`; package validation rejects missing application PRI files, architecture mismatches, and incomplete self-contained runtimes.
