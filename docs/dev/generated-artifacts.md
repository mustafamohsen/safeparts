...
The preparation script targets macOS 14 by default and strips trailing whitespace from generated text. Set `MACOSX_DEPLOYMENT_TARGET` explicitly only when testing another supported target.
